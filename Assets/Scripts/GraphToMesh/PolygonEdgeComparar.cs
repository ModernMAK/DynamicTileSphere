...
{
    public class
        PolygonEdgeComparar<PolyType, EdgeType, NodeType> : IEqualityComparer<PolygonEdge<PolyType, EdgeType, NodeType>>
        ...
        where NodeType : GraphNode<PolyType, EdgeType, NodeType>, new()
    {
        ...
        {
            var hCode = obj.Edge.GetHashCode() ^ obj.Twin.GetHashCode();
