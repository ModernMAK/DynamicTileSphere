...
namespace ProceduralMeshFramework
{
    public struct ProceduralTriangle : IEnumerable<int>
    {
        ...
        public int Pivot
        {
            get { return Indicies[0]; }
            set { Indicies[0] = value; }
        }

        public int Left
        {
            get { return Indicies[1]; }
            set { Indicies[1] = value; }
        }

        public int Right
        {
            get { return Indicies[2]; }
            set { Indicies[2] = value; }
        }

        public int this[int i]
        {
            get { return Indicies[i]; }
            set { Indicies[i] = value; }
        }
