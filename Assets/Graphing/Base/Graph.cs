...
namespace Graphing
{
    ...
    {
        public List<IGraphNode> NodeList { get; protected set; }
        public List<IGraphEdge> EdgeList { get; protected set; }
        public List<IGraphPoly> PolygonList { get; protected set; }
        ...
        public IEnumerable<IGraphEdge> Edges
        {
            get
            {
                return EdgeList;
        ...
        public IEnumerable<IGraphPoly> Polygons
        {
            get
            {
                return PolygonList;
